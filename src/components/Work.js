          ...
          <motion.div
            ...
            <div>
              <h2 className='h2 leading-tight text-accent'>Meus últimos <br />
                trabalhos</h2>
              <p className='max-w-sm mb-16'>Como desenvolvedor freelancer, crio sites modernos e responsivos com uma experiência de usuário excepcional.</p>
              <button className='btn btn-sm'>Veja alguns projetos</button>
            </div>
            <div style={{ borderRadius: 10 }} className='group relative overflow-hidden border-2 border-white/50'>
